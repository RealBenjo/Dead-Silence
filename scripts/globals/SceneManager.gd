...
var _loading_screen_scene:PackedScene = preload("res://scenes/menus/loading screen/loading_screen.tscn") ## reference to loading screen PackedScene
...
func _add_loading_screen(transition_type:String="fade_to_black"):
	...
	Globals.gui.add_child(_loading_screen)
